function example_cox_Trace(floder, name_train, name_test,lam_iter,Smallest_lambda_rate,ratepp)
current_path=cd;
...
for i = 1: Num_lambda
    ...
    [B funcVal_B] = Cox_Trace(train_cell, B_old, lambda(i), opts);
...
%the possible best result with different regularizer parameter
